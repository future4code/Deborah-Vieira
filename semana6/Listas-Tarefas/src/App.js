...
class App extends React.Component {
  ...
  componentDidUpdate() {
    const tarefaObj = this.state.tarefas
    localStorage.setItem("tarefas", JSON.stringify(tarefaObj))
  };
  ...
  selectTarefa = (id) => {
    console.log("Altera tarefa", id)
      const tarefasLista = this.state.tarefas.map(tarefa => {
        if(id === tarefa.id){
          const novaTarefa = {
            ...tarefa, 
      ...
      this.setState({tarefas: tarefasLista})
  }
